...
//controllers
mainController.$inject=['cartService','$scope','compareProductsService','productService'];
function mainController(cartService,$scope,compareProductsService,productService){
    var vm=this;
...
function loginService(){
    ...
    account.personInfo={};//name,email,password
    account.shippingAddress={};//name,address line1 line2,city,province,zip,country, phone
    account.payment={};//credit information --- name on card, card number,expiration date(month/year)
